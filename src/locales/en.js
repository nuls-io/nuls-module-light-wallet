...
const en = {
  ...
  "error": {
    ...
    "ac_0009": "There is another AliasTransaction set to the same alias",
    ...
    "ac_0040": "Incorrect chain id",
    "ac_0041": "Incorrect asset id",
    "ac_0042": "The signature address of the transaction does not match the coin from address",
    ...
    "cm_1007": "Chain magic number already exists",
    "cm_1008": "Chain name already exist",
    "cm_2000": "Asset Symbol cannot be null",
    "cm_2001": "Asset Symbol length error",
    "cm_2002": "Asset Symbol already exists",
    "cm_2003": "JSON cannot be transfered to Asset object",
    ...
    "cm_2014": "Asset not exists",
    "cm_2015": "Asset number exceeds initialization quantity",
    ...
    "cs_0001": "data error",
    "cs_0002": "tx does not exist",
    "cs_0003": "agent does not exist",
    "cs_0004": "data does not exist",
    "cs_0005": "incorrect address",
    "cs_0006": "incorrect param",
    ...
    "nw_0002": "Net message send failure",
    ...
    "sc_0104": "Incorrect password",
    "sc_0105": "Account does not exist",
    "sc_0106": "Incorrect Address",
    ...
    "tx_0025": "Transaction ledger verify failure",
  ...
  "newConsensus": {
    ...
    "newConsensus8": "Margin should not be less than 2000 and not more than 500000",
    "newConsensus9": "Please enter the Commission ratio.",
    "newConsensus10": "The commission ratio must be numeric",
    "newConsensus11": "Margin should not be less than 10 and not more than 100",
  },
  ...
  "newAddress": {
    ...
    "newAddress5": "Please keep your wallet password stored safely. NULS wallet does not store your password and can't help you find it. Please keep it in mind.",
  ...
  "setAlias": {
    ...
    "setAlias5": "Please enter an alias (only lowercase letters, numbers, underscores are allowed, also underscores cannot be at both ends)",
  },
  ...
  "deploy": {
    ...
    "deploy81": "Gas Limit range;1~10000000",
    ...
    "deploy20": "Contract name (only lowercase letters, numbers, underscores are allowed, also underscores cannot be at both ends)",
  ...
  "codeInfo": {
    ...
    "codeInfo5": "Sorry, source code certification failed!",
    ...
    "codeInfo9": "2. The file directory structure and code in the zip package need to be consistent with deployment code, or it will result in certification failure",
    "codeInfo10": "Sorry, the maximum upload file size is 5MB",
  ...
  "contractInfo": {
    ...
    "contractInfo13": "Failed to verify contract deletion:",
  ...
  "TipsType": {
    ...
    "4": "The latest version is now in use, no updates are needed.",
  },
  ...enLocale
