...
export const defaultData = [
  {name: 'Official',chainId:2,assetId:1,decimals:8,chainName:'tNULS', urls: 'http://192.168.1.192:18003/', delay: '10ms', state: 0, isDelete: false},
...
//默认服务节点地址
export const defaultUrl ={name: 'Official',chainId:2,assetId:1,decimals:8,chainName:'tNULS', urls: 'http://192.168.1.40:18003/', delay: '10ms', state: 1, isDelete: false};
//默认浏览器地址（跳转地址）
